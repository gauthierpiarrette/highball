...
enum L10n {
    static let fr: [String: String] = [
        ...
        "%@ is verified on the %@ engine, and its installer fails on this environment's Wine build. A new environment keeps your other programs where they are%@. Moving this environment re-runs the Windows setup and keeps everything installed.": "%@ est vérifié sur le moteur %@, et son installateur échoue avec la version de Wine de cet environnement. Un nouvel environnement laisse vos autres programmes où ils sont%@. Déplacer cet environnement relance la configuration Windows et conserve tout ce qui est installé.",
