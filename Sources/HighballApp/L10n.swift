...
enum L10n {
    static let fr: [String: String] = [
        ...
        "Make a shortcut…": "Créer un raccourci…",
        ...
        "Make a shortcut: a small Mac app for this game in ~/Applications/Highball. Put it in the Dock or open it from Spotlight or Launchpad to play without opening Highball first.": "Crée un raccourci : une petite app Mac pour ce jeu dans ~/Applications/Highball. Mettez-la dans le Dock ou ouvrez-la depuis Spotlight ou Launchpad pour jouer sans ouvrir Highball.",
        "Running": "En cours",
        "Stop": "Arrêter",
