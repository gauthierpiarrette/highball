...
enum L10n {
    static let fr: [String: String] = [
        ...
        "Highball will keep its engines and environments in this folder. It must be on an APFS volume (external drives formatted as exFAT cannot hold a Windows environment).": "Highball gardera ses moteurs et environnements dans ce dossier. Il doit être sur un volume APFS (un disque externe en exFAT ne peut pas contenir un environnement Windows).",
